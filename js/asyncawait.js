...
function myAsync(task) {
  ...
  return new Promise((resolve, reject) => {
    function runner(data) {
      ...
      Promise.resolve(nextObj.value).then(runner).catch(reject);
    }
...
myAsync(task1).then((data) => console.log("task1:", data));
...
myAsync(task2).catch((err) => console.log("task2:", err));
...
myAsync(task3).catch((err) => console.log("task3:", err));
